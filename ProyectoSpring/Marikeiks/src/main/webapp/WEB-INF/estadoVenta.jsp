		...
		<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
			...
			<body>
				<div class="container">
					...
					<h1>
						<p class="text-primary">Ingrese sus estados de venta</p>
					</h1>
					<br>
					...
					<br>
					<h1>
						<p class="text-secondary" align="center">Lista de estados ingresados</p>
					</h1>
							...
							<tbody>
								<c:forEach var="estado_venta" items="${listaEstados}">
									<tr>
										...
										<td><a class="btn btn-warning" href="/estadoVenta/editar/${estadoVenta.id}"
												role="button">Editar</a></td>
										<td><a class="btn btn-danger" href="/estadoVenta/eliminar/${estadoVenta.id}"
